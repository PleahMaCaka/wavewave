(()=>{var h=class{static floatTo16BitPCM(e){let t=new ArrayBuffer(e.length*2),s=new DataView(t),n=0;for(let r=0;r<e.length;r++,n+=2){let a=Math.max(-1,Math.min(1,e[r]));s.setInt16(n,a<0?a*32768:a*32767,!0)}return t}static mergeBuffers(e,t){let s=new Uint8Array(e.byteLength+t.byteLength);return s.set(new Uint8Array(e),0),s.set(new Uint8Array(t),e.byteLength),s.buffer}_packData(e,t){return[new Uint8Array([t,t>>8]),new Uint8Array([t,t>>8,t>>16,t>>24])][e]}pack(e,t){if(t?.bitsPerSample)if(t?.channels){if(!t?.data)throw new Error('Missing "data"')}else throw new Error('Missing "channels"');else throw new Error('Missing "bitsPerSample"');let{bitsPerSample:s,channels:n,data:r}=t,a=["RIFF",this._packData(1,52),"WAVE","fmt ",this._packData(1,16),this._packData(0,1),this._packData(0,n.length),this._packData(1,e),this._packData(1,e*n.length*s/8),this._packData(0,n.length*s/8),this._packData(0,s),"data",this._packData(1,n[0].length*n.length*s/8),r],i=new Blob(a,{type:"audio/mpeg"}),u=URL.createObjectURL(i);return{blob:i,url:u,channelCount:n.length,sampleRate:e,duration:r.byteLength/(n.length*e*2)}}};globalThis.WavPacker=h;var B=[4186.01,4434.92,4698.63,4978.03,5274.04,5587.65,5919.91,6271.93,6644.88,7040,7458.62,7902.13],R=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],g=[],b=[];for(let l=1;l<=8;l++)for(let e=0;e<B.length;e++){let t=B[e];g.push(t/Math.pow(2,8-l)),b.push(R[e]+l)}var A=[32,2e3],P=g.filter((l,e)=>g[e]>A[0]&&g[e]<A[1]),D=b.filter((l,e)=>g[e]>A[0]&&g[e]<A[1]);var p=class l{static getFrequencies(e,t,s,n="frequency",r=-100,a=-30){s||(s=new Float32Array(e.frequencyBinCount),e.getFloatFrequencyData(s));let i=t/2,u=1/s.length*i,f,o,c;if(n==="music"||n==="voice"){let m=n==="voice"?P:g,d=Array(m.length).fill(r);for(let v=0;v<s.length;v++){let _=v*u,q=s[v];for(let w=m.length-1;w>=0;w--)if(_>m[w]){d[w]=Math.max(d[w],q);break}}f=d,o=n==="voice"?P:g,c=n==="voice"?D:b}else f=Array.from(s),o=f.map((m,d)=>u*d),c=o.map(m=>`${m.toFixed(2)} Hz`);let y=f.map(m=>Math.max(0,Math.min((m-r)/(a-r),1)));return{values:new Float32Array(y),frequencies:o,labels:c}}constructor(e,t=null){if(this.fftResults=[],t){let{length:s,sampleRate:n}=t,r=new OfflineAudioContext({length:s,sampleRate:n}),a=r.createBufferSource();a.buffer=t;let i=r.createAnalyser();i.fftSize=8192,i.smoothingTimeConstant=.1,a.connect(i);let u=1/60,f=s/n,o=c=>{let y=u*c;y<f&&r.suspend(y).then(()=>{let k=new Float32Array(i.frequencyBinCount);i.getFloatFrequencyData(k),this.fftResults.push(k),o(c+1)}),c===1?r.startRendering():r.resume()};a.start(0),o(1),this.audio=e,this.context=r,this.analyser=i,this.sampleRate=n,this.audioBuffer=t}else{let s=new AudioContext,n=s.createMediaElementSource(e),r=s.createAnalyser();r.fftSize=8192,r.smoothingTimeConstant=.1,n.connect(r),r.connect(s.destination),this.audio=e,this.context=s,this.analyser=r,this.sampleRate=this.context.sampleRate,this.audioBuffer=null}}getFrequencies(e="frequency",t=-100,s=-30){let n=null;if(this.audioBuffer&&this.fftResults.length){let r=this.audio.currentTime/this.audio.duration,a=Math.min(r*this.fftResults.length|0,this.fftResults.length-1);n=this.fftResults[a]}return l.getFrequencies(this.analyser,this.sampleRate,n,e,t,s)}async resumeIfSuspended(){return this.context.state==="suspended"&&await this.context.resume(),!0}};globalThis.AudioAnalysis=p;var E=`
